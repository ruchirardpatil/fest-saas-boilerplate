...
Fest is a SaaS boilerplate built with Node.js & React. It is equipped with the following features:
...
<p align="center">
  <kbd>
    <img width="320" src="https://github.com/ruchirapatil/fest/blob/main/screenshot2.png">
  </kbd>
  <kbd>
    <img width="320" src="https://github.com/ruchirapatil/fest/blob/main/screenshot.png">
  </kbd>
</p>
...
- You will need docker installed on your machine to run the PostgreSQL.
...
- Clone the repo: `git clone https://github.com/ruchirapatil/fest.git`.
...
Ruchira Dayanand Patil is a Software Developer with over 5 years of professional experience in building scalable web applications. With expertise in TypeScript, JavaScript, and RESTful architectures, Ruchira maintains this project to ensure a robust foundation for SaaS development.
